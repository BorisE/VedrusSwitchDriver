...
; Generated by Boris Emchenko on 18.04.2020 (UTC)
;
[Setup]
AppID={{4b4aee9e-e1c7-44aa-b640-aac35e85b522}
AppName=ASCOM Vedrus2 Switch Driver
AppVerName=ASCOM Vedrus2 Switch Driver 2.0.0
AppVersion=2.0.0
...
OutputDir="."
OutputBaseFilename="Vedrus2 Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Switch\Vedrus2"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Switch\Vedrus2"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\Users\Emchenko\source\repos\BorisE\VedrusSwitchDriver\VedrusSwitchDriver\bin\Release\ASCOM.Vedrus.Switch2.dll"; DestDir: "{app}"
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Vedrus.Switch2.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Vedrus.Switch2.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.Vedrus.Switch2.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Vedrus.Switch2.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.Vedrus.Switch2.dll"""; Flags: runhidden 64bit; Check: IsWin64
